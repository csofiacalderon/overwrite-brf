...
PCP_COPAY_DATA = read_copay_data('data_files/pcp_copays.csv')
SPS_COPAY_DATA = read_copay_data('data_files/spc_copays.csv')
ER_COPAY_DATA = read_copay_data('data_files/er_copays.csv')
