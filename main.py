...
test_plan.calculate_indices(DEDUCTIBLE_THRESHOLD_DATA, COINSURANCE_THRESHOLD_DATA, MOOP_THRESHOLD_DATA)
print(test_plan.calculate_copay_brf(PCP_COPAY_DATA, SPS_COPAY_DATA, ER_COPAY_DATA))
